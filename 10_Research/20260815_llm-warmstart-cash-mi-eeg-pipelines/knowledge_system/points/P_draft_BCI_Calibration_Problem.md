---
schema_version: "1.0"
id: P_draft_BCI_Calibration_Problem
type: point
...
parts: []
depends_on: []
caused_by: [P_draft_Inter_Subject_Variability]
causes: []
related_lines: []
related_planes: []
...
## 啟發
- **被啟發**：[[P_draft_Inter_Subject_Variability]] — 校正問題是受試者間變異的直接後果（caused_by 關係）。
- **啟發了**：[[B_draft_llm-warmstart-cash-mi-eeg-pipelines]] — 本研究核心目標（以跨受試者搜尋歷史與 LLM 先驗暖啟動 CASH，將每受試者搜尋壓縮到 25–100 次評估內）正是對「約 24 小時冷啟動 HPO」的直接回應；[[P_draft_Subjects_as_Tasks]] — 校正成本使「跨受試者遷移搜尋知識」從可選變成必要。
