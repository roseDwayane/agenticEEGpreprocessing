...
## 啟發
- **被啟發**：[[P_draft_LLAMBO]] — 承接「LLM 補足 BO、增益來自語意先驗」的定位，但把 LLM 的角色從 surrogate/取樣器收縮為受條件化的 FE 探索者
- **被啟發**：[[P_draft_SMAC]] — HPO 引擎直接源自 SMAC 的 BO，並示範如何以 meta-features 條件化其 surrogate
