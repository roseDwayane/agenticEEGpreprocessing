...
caused_by: [P_draft_Negative_Transfer]
causes: []
related_lines: []
related_planes: []
...
## 啟發
- **被啟發**：[[P_draft_Negative_Transfer]] — 天真重用的劇烈退化與 surrogate 層的結構性錯估風險，是門控機制存在的理由（caused_by 關係）；[[P_draft_Meta_Features]] — 門控需要任務相似度的座標系，γ-similarity 提供了免 meta-features 的替代方案。
