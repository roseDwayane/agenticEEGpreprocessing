---
schema_version: "1.0"
id: P_draft_LLM_Prior_Elicitation
type: point
...
## 啟發
- **被啟發**：[[P_draft_PiBO]] — πBO 提供「任意信念分布皆可注入且有衰減保證」的注入機制，先驗誘出負責供給該分布
- **被啟發**：[[P_draft_LLAMBO]] — LLAMBO 的 zero-shot warm-start 證明 LLM 內含可用的組態先驗，誘出即其顯式化
