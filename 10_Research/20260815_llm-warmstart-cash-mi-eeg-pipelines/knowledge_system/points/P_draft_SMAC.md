...
## 啟發
- **被啟發**：[[P_draft_CASH]] — CASH 的 conditional 空間結構是 RF surrogate 設計的直接動因
- **啟發了**：[[P_draft_MI_SMAC]] — meta-learning 暖啟動初始化 SMAC（MI-SMBO）以其為基底引擎
- **啟發了**：[[P_draft_CoFEH]] — CoFEH 的 HPO 模組即源自 SMAC 的 BO，並以 FE meta-features 條件化其 surrogate
