---
schema_version: "1.0"
id: P_draft_Anytime_Performance
type: point
...
- **啟發了**：[[B_draft_llm-warmstart-cash-mi-eeg-pipelines]] — 本研究主要 endpoint 直接採 anytime AUC（incumbent balanced-accuracy 曲線下面積）與 evaluations-to-target，於 B ∈ {25, 50, 100} 三個預算點報告（H1 的兩個共同主端點）；[[P_draft_Budget_Matched_Protocol]] — anytime 曲線是預算對齊協議得以逐評估比較的量測基礎，兩者互為表裡。
