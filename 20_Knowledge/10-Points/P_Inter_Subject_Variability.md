---
schema_version: "1.0"
id: P_Inter_Subject_Variability
type: point
...
depends_on: []
caused_by: []
causes: [P_BCI_Calibration_Problem]
related_lines: []
related_planes: []
...
- **啟發了**：[[P_BCI_Calibration_Problem]] — 變異是每位新使用者都需重新校正的直接原因；[[P_Subjects_as_Tasks]] — 差異大到受試者應被建模為 transfer-HPO 的任務家族，且約 30 倍偏差的離群個體使相似度門控（similarity gating）成為防範 negative transfer 的必要設計（本研究 H2 的門控變體與風險評估直接引用此數字）。
