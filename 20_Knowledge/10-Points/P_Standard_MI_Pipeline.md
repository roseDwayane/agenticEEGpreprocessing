...
- **啟發了**：[[P_Subjects_as_Tasks]] — 若標準≠最優且最優因人而異，受試者就自然成為各自需要搜尋的任務；[[B_llm-warmstart-cash-mi-eeg-pipelines]] — 本研究把標準管線設為固定 baseline 對照臂（H2 的比較對象），「標準≠最優」即管線搜尋需求的來源。
