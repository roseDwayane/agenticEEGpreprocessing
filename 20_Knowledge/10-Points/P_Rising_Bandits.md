...
## 啟發
- **被啟發**：[[P_Hyperband]] — 承接「以 bandit 做資源分配、以淘汰加速搜尋」的思想，但把定常報酬改為遞增凹性報酬以貼合 CASH
- **啟發了**：[[P_Search_Space_Decomposition]] — VolcanoML 的 conditioning block 沿用同一「上下界淘汰子空間」機制，將其推廣為可組合的執行計畫節點
