---
schema_version: "1.0"
id: P_Warm_Start_Initialization
type: point
...
updated: 2026-08-15
parent:
parts: [P_MI_SMAC, P_PiBO, P_TransBO, P_Two_Stage_Transfer_Surrogate, P_Zero_Shot_Configuration_Transfer, P_Similarity_Gating, P_Meta_Features]
depends_on: []
caused_by: []
causes: []
related_lines: []
...
## 啟發
- **被啟發**：[[P_MI_SMAC]] — 初始點遷移是最早成熟的管道，survey 的 Initialization Design 分類即以 meta-features 選點（MI-SMBO 一系）為原型；surrogate 層的 [[P_Two_Stage_Transfer_Surrogate]] 與 [[P_TransBO]]、先驗注入的 [[P_PiBO]] 各自填入其餘管道。
